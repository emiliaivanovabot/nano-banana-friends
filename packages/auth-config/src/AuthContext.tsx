...
import { SessionManager, authenticateUser, logout as authLogout, type User, type AuthResult } from './auth-utils'
...
export function AuthProvider({ 
   ...
   */
  const completeOnboarding = (): boolean => {
    try {
