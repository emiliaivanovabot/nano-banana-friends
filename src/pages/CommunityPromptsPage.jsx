...
const communityPrompts = [
  {
    ...
    image: "https://boertlay.de/bilder/images/70738daecf66b056.png"
  },
  {
    id: 7,
    title: "Gini",
    prompt: "Hyper-realistic cinematic Create an 8k photorealistic image. A close-up portrait of a woman with long, jet-black, slightly wind-swept hair falling across her face. Her striking, light-colored eyes gaze upwards and to the right, catching a sharp, diagonal beam of natural light that illuminates the high points of her cheekbone, nose, and plump, glossy, mauve-toned lips a slightly light weight silk",
    category: "Beauty",
    likes: 456,
    author: "bananaprompts.xyz",
    image: "https://boertlay.de/bilder/images/917bfae488d8b000.jpeg"
  },
  {
    id: 11,
    ...
    likes: 387,
    author: "bananaprompts.xyz",
    image: "https://boertlay.de/bilder/images/629f21c3209ebc2a.jpeg"
  },
  {
    id: 18,
    title: "Mulher Elegante",
    prompt: "A composição deve mostrar um retrato feminino de meio corpo, com a modelo sentada e levemente inclinada para a frente. O braço direito deve cruzar o corpo, com a mão esquerda apoiada suavemente no braço oposto, transmitindo elegância e confiança. A expressão facial deve ser serena, confiante e levemente enigmática. O olhar deve estar direcionado à câmera, com os lábios suavemente fechados e postura firme. A roupa é composta por um conjunto escuro e sofisticado — blazer preto estruturado, usado sobre uma blusa preta justa. O cabelo deve estar solto, liso e bem alinhado, caindo sobre um dos ombros de forma natural. A iluminação deve ser de estúdio, com luz direcional suave e contrastada (estilo Rembrandt ou luz lateral), destacando o contorno do rosto, criando sombras elegantes e um degradê sutil no fundo. O fundo deve ser liso e neutro, em tons de cinza escuro, com profundidade leve e sem elementos de distração. O estilo final deve ser preto e branco, com contraste refinado, textura suave da pele e aparência realista de retrato editorial. Formato vertical (1080x1920), proporção retrato, qualidade fotográfica de estúdio profissional, acabamento cinematográfico e realista.",
    category: "Fashion",
    likes: 342,
    author: "bananaprompts.xyz",
    image: "https://boertlay.de/bilder/images/029f12d8df51a5fe.png"
  },
  {
    id: 21,
  ...
  },
  {
    ...
    likes: 234,
    author: "bananaprompts.xyz",
    image: "https://boertlay.de/bilder/images/b64df61d6d42f589.jpeg"
  },
  {
    id: 26,
    ...
    likes: 189,
    author: "bananaprompts.xyz",
    image: "https://boertlay.de/bilder/images/6e1165aa2d5e0e02.jpeg"
  },
  {
    id: 27,
    title: "Low-key portrait photography",
    prompt: "Professional studio portrait of a woman, confident and determined expression, head slightly tilted down, wearing a black V-neck t-shirt. Using a low-key photography setup with butterfly lighting (key light from front above), a hair rim light from behind, and a faint background light. The atmosphere is filled with a subtle haze or smoke. Shot on a medium format camera, high contrast, cinematic, sharp focus, soft shadows. The atmosphere has a subtle haze. Hyper-realistic, shot on a 85mm lens, sharp focus on eyes, detailed facial features. --ar 4:5 --style raw",
    category: "Studio",
    likes: 267,
    author: "bananaprompts.xyz",
    image: "https://boertlay.de/bilder/images/356148c2f6b7bcbf.png"
  },
  {
    id: 29,
    ...
    likes: 223,
    author: "bananaprompts.xyz",
    image: "https://boertlay.de/bilder/images/9383bfc74dea4a38.png"
  },
  {
    id: 30,
  ...
  },
  {
    ...
    likes: 423,
    author: "bananaprompts.xyz",
    image: "https://boertlay.de/bilder/images/b62532d454dca0ff.jpeg"
  },
  {
    id: 39,
    ...
    likes: 367,
    author: "bananaprompts.xyz",
    image: "https://boertlay.de/bilder/images/cba7df26f8f20d27.jpeg"
  },
  {
    id: 43,
    ...
    likes: 234,
    author: "bananaprompts.xyz",
    image: "https://boertlay.de/bilder/images/90505e9d7e9468c2.jpeg"
  },
  {
    id: 44,
    title: "Dark Studio",
  ...
  },
  {
    ...
    likes: 445,
    author: "bananaprompts.xyz",
    image: "https://boertlay.de/bilder/images/68d33aab2a852dd4.jpeg"
  },
  {
    id: 1,
    title: "Urban Reflection in Dramatic Light",
    prompt: "Dramatic, ultra-realistic close-up in black and white with high-contrast cinematic lighting from the side, highlighting the contours of my face, casting deep shadows. I wear round, reflective sunglasses. I gaze confidently upward into a dark void. The sunglasses reflect a city's towering skyline. The atmosphere is mysterious with a minimalist black background. Details in 4K.",
    category: "Portrait",
    likes: 342,
    author: "bananaprompts.xyz",
    image: "https://boertlay.de/bilder/images/7fc4e92c99921c79.png"
  },
  {
    id: 12,
    ...
    likes: 298,
    author: "bananaprompts.xyz",
    image: "https://boertlay.de/bilder/images/c8929263126d44a3.jpeg"
  },
  {
    id: 13,
    title: "Studio Photography",
    prompt: "Studio photography of me in a black suit, black turtleneck and round sunglasses with translucent yellow lenses. Vibrant orange background. Unique poses from the front.",
    category: "Studio",
    likes: 256,
    author: "bananaprompts.xyz",
    image: "https://boertlay.de/bilder/images/091a733e3bea53c2.jpeg"
  },
  {
    id: 14,
    title: "Propt moto esportiva",
    prompt: "Um retrato ultra-realista. Eu estou sentada em uma Moto esportiva preta brilhante em uma área ao ar livre contra o fundo de árvores verdes. Eu uso uma camiseta preta solta, jeans escuros soltos com dobras na parte inferior e tênis Nike preto e branco. Os acessórios usados incluem um relógio preto. Minha mão esquerda descansou casualmente em minha coxa, enquanto minha mão direita descansou na moto enquanto segurava um capacete preto brilhante com uma viseira transparente. A moto parece detalhada com um motor grande, quadro forte e detalhes cromados brilhantes, acentuando a impressão moderna e poderosa. O fundo mostra árvores altas com luz natural suave, criando uma mistura equilibrada de sombra e luz. A expressão é calma e confiante, olhando diretamente para a câmera. O estilo geral é cinematográfico e moderno, combinando a sensação de streetwear jovem com a presença de uma motocicleta arrojada. Alta resolução, estilo editorial fotorrealista.",
    category: "Automotive",
    likes: 278,
    author: "bananaprompts.xyz",
    image: "https://boertlay.de/bilder/images/bd91f6c7d066bf0c.jpeg"
  },
  {
    id: 19,
    title: "Reflections in style",
    prompt: "Ultra-realistic mirror selfie of a stylish woman with glasses. She is wearing a loose white sweater layered over a crisp white T-shirt, paired with dark blue denim jeans. She holds a new modern iPhone 17 smartphone orange colour in one hand, partially covering her face, while her other hand rests casually in her pocket. The scene is set in warm indoor lighting, creating a cinematic, moody atmosphere with soft shadows.",
    category: "Lifestyle",
    likes: 234,
    author: "bananaprompts.xyz",
    image: "https://boertlay.de/bilder/images/35660421bca812e3.png"
  },
  {
    id: 25,
    title: "Instinct and Spirit",
    prompt: "Create a realistic and emotional scene showing a woman and a lion face to face in a moment of connection and respect. The woman's eyes are closed, with a serene expression, while the lion gently rests its forehead and muzzle against hers, conveying trust and a spiritual bond. Both are standing on ground covered in light snow, with snowflakes gently falling. The woman wears a dark coat and hair slightly tousled by the wind, and the lion displays a thick, majestic mane.",
    category: "Artistic",
    likes: 389,
    author: "bananaprompts.xyz",
    image: "https://boertlay.de/bilder/images/d2c3fda790a788bc.png"
  },
  {
    id: 51,
    title: "Street Photographer",
    prompt: "Edit this image — transform the photo into a high-end street-photography portrait of a female traveler/photographer leaning casually on a lamp post in front of a historic tower. Keep the original pose and composition: standing with left leg bent and foot on the lamp base, right leg relaxed, left hand in jacket pocket, right hand holding a camera down by the thigh, shoulders slightly turned to camera, chin up and gaze off-frame. Preserve the camera and textured jacket but enhance and stylize with wardrobe & accessories: keep the dark parka/jacket but enrich fabric texture (subtle waxed canvas look), change inner hoodie to a soft charcoal knit, keep blue jeans but slightly deepened to rich indigo with natural creasing. Emphasize the high-top sneakers — boost contrast on black-and-white panels and add faint scuff details for realism.",
    category: "Street",
    likes: 267,
    author: "bananaprompts.xyz",
    image: "https://boertlay.de/bilder/images/0882628d695aacbb.png"
  },
  {
    id: 52,
    title: "Crafting the Night",
    prompt: "Cinematic photorealistic portrait, vertical composition, saturated and vivid colors. A woman stands outdoors at sunset, waist up, in the right third of the frame, in profile facing left. She holds a giant, bright full moon in both hands, palms supporting its lower part, fingers spread. The moon is large, occupying the upper left quadrant, glowing intensely in a golden orange, with visible craters and texture, radiating strong light. The woman wears a light grayish-beige dress shirt. Her skin and face are illuminated by a warm, deep orange light from the bright moon. Background: dramatic, saturated twilight sky, deep fiery orange and intense crimson red near the horizon, merging upward into a dark purple-violet.",
    category: "Cinematic",
    likes: 445,
    author: "bananaprompts.xyz",
    image: "https://boertlay.de/bilder/images/e06f1983d40617fa.png"
  },
  {
    id: 53,
    title: "Love with lion",
    prompt: "A hyper-realistic cinematic portrait of a woman. She exudes the personality of a powerful and confident leader, sitting confidently on a luxurious velvet sofa, leaning back in a comfortable yet dominant posture. A lion rests on her lap, its body flowing naturally and comfortably above it. The woman's head tilted slightly downward, looking at the cat with a calm and serene expression, while dark sunglasses enhance her aura of dominance and elegance. One hand rests casually on the cat back, the other on the sofa's armrest. She wears a dark, elegant outfit.",
    category: "Artistic",
    likes: 456,
    author: "bananaprompts.xyz",
    image: "https://boertlay.de/bilder/images/9ea6fbdb492df0f6.jpeg"
  },
  {
    id: 55,
    title: "Work Profile",
    prompt: "Create a realistic professional portrait of a woman sitting at an office desk with a laptop and documents in front of her. She is wearing a light beige blazer over a light blue shirt, sitting confidently in a modern office environment with natural lighting and a soft background including a plant and a picture frame. The overall vibe should be clean, professional, and elegant, like a business executive headshot. High resolution, cinematic lighting, realistic textures, detailed depth of field.",
    category: "Professional",
    likes: 298,
    author: "bananaprompts.xyz",
    image: "https://boertlay.de/bilder/images/9cd978fb418dcb02.jpeg"
  },
  {
    id: 61,
    title: "The Low-Key Hacker",
    prompt: "A portrait using my face, depicted as a female hacker in a dark, rainy urban environment, strongly in the style of Mr. Robot. The subject is wearing a large hooded sweatshirt, covering the entire head but leaving the face visible, looking at the camera, with a computer screen reflecting a soft green code onto their face. The lighting is dramatic and low-contrast, with only the monitor light and some blurred streetlights in the background. There is a sense of isolation and paranoia. The image has a grainy, almost cinematic aesthetic, reminiscent of modern noir films, with a focus on technology and surveillance.",
    category: "Tech",
    likes: 367,
    author: "bananaprompts.xyz",
    image: "https://boertlay.de/bilder/images/957d677e6f197f79.png"
  }
]
