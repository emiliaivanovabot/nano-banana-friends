...
function NonoBananaPage() {
  ...
  const [showPersonalization, setShowPersonalization] = useState(
    userSettings?.use_personalization !== undefined ? userSettings.use_personalization : true
  )
  ...
  // Update personalization state when userSettings change
  useEffect(() => {
    if (userSettings?.use_personalization !== undefined) {
      setShowPersonalization(userSettings.use_personalization)
    }
  }, [userSettings])
